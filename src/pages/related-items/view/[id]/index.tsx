...
import { getRelatedItemById } from 'apiSdk/related-items';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Related Item Detail View
          </Text>
          {hasAccess('related_item', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/related-items/edit/${data?.id}`} passHref legacyBehavior>
              <Button
